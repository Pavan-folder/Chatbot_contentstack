...
import EnhancedChatbotWidgetFixed from './components/EnhancedChatbotWidgetFixed';

function AppWithScrollingFixed() {
  return (
    <div className="App">
      ...
      <EnhancedChatbotWidgetFixed />
    </div>
  );
}

export default AppWithScrollingFixed;
