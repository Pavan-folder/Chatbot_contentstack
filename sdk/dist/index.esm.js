...
var Chat = function (_a) {
    ...
    return (jsxs("div", __assign({ style: { width: '400px', height: '600px', border: '1px solid #ccc', borderRadius: '8px', display: 'flex', flexDirection: 'column' } }, { children: [jsxs("div", __assign({ style: { flex: 1, padding: '16px', overflowY: 'auto' } }, { children: [messages.map(function (message) { return (jsx("div", __assign({ style: { marginBottom: '12px', textAlign: message.sender === 'user' ? 'right' : 'left' } }, { children: jsx("div", __assign({ style: {
                                ...
                                maxWidth: '80%',
                                wordWrap: 'break-word',
                            } }, { children: message.text })) }), message.id)); }), isLoading && (jsx("div", __assign({ style: { textAlign: 'left', marginBottom: '12px' } }, { children: jsx("div", __assign({ style: { display: 'inline-block', padding: '8px 12px', borderRadius: '8px', backgroundColor: '#f1f1f1' } }, { children: "Typing..." })) }))), jsx("div", { ref: messagesEndRef })] })), jsx("div", __assign({ style: { padding: '16px', borderTop: '1px solid #ccc' } }, { children: jsxs("div", __assign({ style: { display: 'flex' } }, { children: [jsx("input", { type: "text", value: input, onChange: function (e) { return setInput(e.target.value); }, onKeyPress: handleKeyPress, placeholder: "Type your message...", style: { flex: 1, padding: '8px', border: '1px solid #ccc', borderRadius: '4px' }, disabled: isLoading }), jsx("button", __assign({ onClick: sendMessage, disabled: isLoading || !input.trim(), style: { marginLeft: '8px', padding: '8px 16px', backgroundColor: '#007bff', color: 'white', border: 'none', borderRadius: '4px', cursor: 'pointer' } }, { children: "Send" }))] })) }))] })));
};
